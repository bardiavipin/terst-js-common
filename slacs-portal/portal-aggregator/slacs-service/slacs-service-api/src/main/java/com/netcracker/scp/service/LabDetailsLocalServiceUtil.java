...
/**
 * Provides the local service utility for LabDetails. This utility wraps
 * {@link com.netcracker.scp.service.impl.LabDetailsLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class LabDetailsLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.netcracker.scp.service.impl.LabDetailsLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.netcracker.scp.model.LabDetails addLabDetails(
		com.netcracker.scp.model.LabDetails labDetails) {
		return getService().addLabDetails(labDetails);
	}
	...
	*/
	public static com.netcracker.scp.model.LabDetails createLabDetails(
		long labId) {
		return getService().createLabDetails(labId);
	}
	...
	*/
	public static com.netcracker.scp.model.LabDetails deleteLabDetails(
		com.netcracker.scp.model.LabDetails labDetails) {
		return getService().deleteLabDetails(labDetails);
	}
	...
	*/
	public static com.netcracker.scp.model.LabDetails deleteLabDetails(
		long labId) throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteLabDetails(labId);
	}

	public static com.netcracker.scp.model.LabDetails fetchLabDetails(
		long labId) {
		return getService().fetchLabDetails(labId);
	}
	...
	*/
	public static com.netcracker.scp.model.LabDetails fetchLabDetailsByUuidAndGroupId(
		java.lang.String uuid, long groupId) {
		return getService().fetchLabDetailsByUuidAndGroupId(uuid, groupId);
	}

	public static com.netcracker.scp.model.LabDetails getLabDetails() {
		return getService().getLabDetails();
	}
	...
	* @throws PortalException if a lab details with the primary key could not be found
	*/
	public static com.netcracker.scp.model.LabDetails getLabDetails(long labId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getLabDetails(labId);
	}
	...
	*/
	public static com.netcracker.scp.model.LabDetails getLabDetailsByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getLabDetailsByUuidAndGroupId(uuid, groupId);
	}
	...
	*/
	public static com.netcracker.scp.model.LabDetails updateLabDetails(
		com.netcracker.scp.model.LabDetails labDetails) {
		return getService().updateLabDetails(labDetails);
	}
	...
	*/
	public static int getLabDetailsesCount() {
		return getService().getLabDetailsesCount();
	}
	...
	*/
	...
	public static java.util.List<com.netcracker.scp.model.LabDetails> findByStatus(
		boolean status, long companyId, int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByStatus(status, companyId, start, end);
	}

	public static java.util.List<com.netcracker.scp.model.LabDetails> findByUser(
	...
	*/
	public static java.util.List<com.netcracker.scp.model.LabDetails> getLabDetailses(
		int start, int end) {
		return getService().getLabDetailses(start, end);
	}
	...
	*/
	public static java.util.List<com.netcracker.scp.model.LabDetails> getLabDetailsesByUuidAndCompanyId(
		java.lang.String uuid, long companyId) {
		return getService().getLabDetailsesByUuidAndCompanyId(uuid, companyId);
	}
	...
	*/
	public static java.util.List<com.netcracker.scp.model.LabDetails> getLabDetailsesByUuidAndCompanyId(
		...
		return getService()
				   .getLabDetailsesByUuidAndCompanyId(uuid, companyId, start,
	...
	*/
	...
	public static LabDetailsLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<LabDetailsLocalService, LabDetailsLocalService> _serviceTracker =
		ServiceTrackerFactory.open(LabDetailsLocalService.class);
}